...
function Navbar() {
  ...
  return (
    <div className='z-10 fixed top-0 w-full p-[4svh] h-[4.5rem] rounded-md flex justify-between px-[7vw]'>
        <Link href="/" scroll={true}><span className='text-3xl my-auto'>Angad | Portfolio</span></Link>
        ...
        <div className={`lg:hidden md:hidden bg-black sm:hidden ${value?"translate-x-0":"translate-x-[300%]"} h-fit fixed top-[5rem] p-8  right-0 z-50 border-gray-300 border-2 w-[10rem]`}>
